...
<div>
    ...
    <q-modal minimized ref="aboutModal">
        <div class="about-modal">
            ...
            <p class="q-my-sm">Copyright (c) -2019, turbobit</p>
            ...
            <div class="q-mt-md q-mb-lg external-links">
                <p>
                    <a @click="openExternal('https://wtip.gonspool.com')" href="#">https://wtip.gonspool.com</a>
                </p>
                <p>
                    <a @click="openExternal('https://worktips.xyz')" href="#">https://worktips.xyz</a>
                </p>
                <p>
                    <a @click="openExternal('https://github.com/turbobit/worktips-electron-gui-wallet')" href="#">Github</a>
                </p>
            </div>
